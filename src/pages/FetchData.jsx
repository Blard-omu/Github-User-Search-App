  ...
  return (
    <div className='main shadow col-12 col-md-6 offset-md-3'>
      ...
      <form className='my-4' onSubmit={handleSubmit}>
        ...
        <button className='btn btn-info text-light' type="submit">Search</button>
      </form>
      ...
      {loading ? (
        ...
        <div className="card shadow-lg">
          ...
          <p className=''>Followers: <span className='text-secondary ms-md-2'>{data.followers}</span></p>
          <p className='ms-md-4'>Following: <span className='text-secondary ms-s-2'>{data.following}</span></p>
          <p><NavLink to={data.html_url} target='_blank'><img src={github} alt="" /></NavLink></p>
          </div>
        </div>
      ) : null}
    </div>
